...
import BottomNavigation from './bottomnavCancelled';
        ...
        <ScrollView>
            ...
            >
                ...
                <TouchableOpacity style={styles.userInfoContainer}>
                    ...
                    <Text style={styles.awardMiles}>Available Award miles : 55,000</Text>
                </TouchableOpacity>
                ...
                <View style={styles.planeHeader}>
                    ...
                    <View style={{ backgroundColor: 'red', width: 100, height: 30, marginLeft: (screenWidth * shiftPercentage) / 100, marginTop: -30, marginBottom: 15 }}>
                        <Text style={{ margin: 7, color: 'white', textAlign: 'center', fontSize: 12, fontWeight: '600' }}>CANCELLED</Text>
                    </View>
