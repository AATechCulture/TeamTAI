...
import BottomSwipe from './CancelSwipe';
...
const shiftPercentage = 75;

const FlightCancellationScreen = () => {
    ...
    >   
        ...
        <View style={{backgroundColor:'#ff4d01', width: 120, marginLeft: (screenWidth * shiftPercentage) / 100, }}>
        <Text style={{margin: 10, color: 'white', textAlign:'center'}}>CANCELLED</Text>
        </View>
...
export default FlightCancellationScreen;
